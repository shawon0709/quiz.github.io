...
$.getJSON( "lib/jsons/data.json", function( json ) {
    quiz = json.quiz1;
        ...
        switch (totalClick) {
            ...
            case 20:
                ...
                setTimeout(function(){
                    ...
                    $("#quiz").append("<span class=\"label label-success\" ><span class=\"glyphicon glyphicon-menu-right\"></span></span> " + resList[ansr-10]);
